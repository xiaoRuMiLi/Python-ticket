...
def get_portfolio(stock_list,state_dt,para_window):
    ...
    # 建评估时间序列, para_window参数代表回测窗口长度, 取state_dt 时间前 para_window天的日期
    ...
    for i in range(len(model_test_date_seq)-4):
        ...
        # print(ri)
        # 组成二维数组 [[股票1后三天平均价比第一天上涨的百分比，股票2后三天平均价比第一天上涨的百分比]，[股票1后三天平均价比第一天上涨的百分比，股票2后三天平均价比第一天上涨的百分比]]
